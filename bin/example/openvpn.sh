...
repo="$HOME/Projects/src/github.com/dpb587/openvpn-bosh-release"
...
./bin/generate-metalink-artifacts-data.sh "git+https://github.com/dpb587/openvpn-bosh-release.git//release/stable#artifacts"
...
params:
  ...
  - title: releases
    url: /releases/
  - title: github
    url: &github "https://github.com/dpb587/openvpn-bosh-release"
  ThemeNavBadges:
  - title: BOSH
    color: "#fff"
  ...
  CopyrightNotice: |
    [OpenVPN BOSH Release](https://github.com/dpb587/openvpn-bosh-release) by [Danny Berger](https://dpb587.me/).
  GitRepo: *github
